...
# make comments!!!
from DEV_HackingGameFunctions import DetectionChance, HackingContracts, PasswordCracker, DataExtraction, DDoSAttack, PlayerInventory, clear, checkBalance, UpdateBalance, StellarSolutions, GlobalBank, QuickLoansCorporation
...
def HackingStore():
    ...
    from DEV_HackingGameFunctions import balance, inventory
    clear()
